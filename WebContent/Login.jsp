...
<div id="login-holder">
	...
	<div id="logo-login">
		...
		<a href="" class="back-login"><img src="images/shared/logo.png" width="156" height="40" alt="" /></a>
	</div>
	<!-- end logo -->
	...
	<!-- </table>  -->
		...
		<tr>
			<th>Password</th>
			<td><input type="password"  onfocus="this.value=''" class="login-inp"  name="pass"/></td>
		</tr>
		<tr>
			<th></th>
